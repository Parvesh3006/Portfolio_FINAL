...
const research = [
  ...
  {
    title:
      "Deep Learning–Driven OCT Skin Layer Analysis for Diabetic Foot Ulcer Detection",
    abstract:
  ...
  },
  {
    ...
    technologies: ["Blockchain", "Quantum Security", "Cryptography"],
    innovation:
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-[#9ca3af] mt-6 max-w-2xl mx-auto">
            Advancing AI, cybersecurity, blockchain, medical imaging, and
            intelligent edge systems through research and innovation.
          </p>
        </motion.div>
          ...
          {research.map((paper, index) => (
            ...
            >
              <BorderGlow
                ...
                fillOpacity={0.5}
              >
                <div className="relative h-full p-5 sm:p-6 rounded-3xl bg-gradient-to-br from-[#0F1115] to-black border border-[#00FF99]/20 overflow-hidden">
                  {/* Glow */}
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="mb-5 p-4 rounded-2xl bg-[#00FF99]/5 border border-[#00FF99]/10">
                      ...
                      <p className="text-[#9ca3af] text-sm">{paper.innovation}</p>
                    </div>
                      ...
                      >
                        {paper.publicationLink && (
                          <a
                            ...
                            className="flex items-center justify-center gap-2 px-4 py-3 rounded-2xl bg-cyan-400/10 border border-cyan-400/30 text-cyan-300 hover:bg-cyan-400 hover:text-black transition-all duration-300 text-sm font-medium w-full max-w-[260px]"
                          >
                        ...
                        {paper.authorProfile && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-2 px-4 py-3 rounded-2xl bg-green-400/10 border border-green-400/30 text-green-300 hover:bg-green-400 hover:text-black transition-all duration-300 text-sm font-medium"
                          >
